...
class TestEndToEnd:
    ...
    def test_full_workflow(self, mock_thread, mock_eclient_init, mock_env_vars, sample_trades_data):
        ...
        with patch('ib_data_sdk.client.ContractHandler.create_contract_from_request'), \
             patch('ib_data_sdk.client.DataProcessorFactory.create_processor') as mock_factory:
